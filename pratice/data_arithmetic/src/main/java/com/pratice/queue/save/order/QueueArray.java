package com.pratice.queue.save.order;

import com.pratice.queue.Queue;
import com.pratice.queue.QueueEmptyException;

/**
 * @author zakyoung
 * @Title:
 * @Description: TODO  Queue 的顺序存储实现
 * @date 2018-05-01
 */
public class QueueArray implements Queue {
    ...
    //返回队列的大小
    public int getSize() {
        return  (rear -front+ capacity)%capacity;//使用的数组是占比
    }
